...
def test_extract_cookies_via_cdp_waits_for_debugger_after_launcher_exits(monkeypatch) -> None:
    """Windows may re-parent Chrome before CDP binds; the port, not parent PID, wins."""
